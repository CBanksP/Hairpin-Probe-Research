...
SEND_EMAIL = True  # Toggle to enable/disable email notification
...
def acquire_vacuum_resonance_data(
    ...
    return df, f'{run_name}_raw_data_plot.png'
...
if __name__ == "__main__":
    ...
    data, plot_path = acquire_vacuum_resonance_data(
        rp_host=RP_HOST,
        mw_device=MW_DEVICE,
    ...
    print(f"Raw data plot saved as {plot_path}")

    if SEND_EMAIL:
        # Send email notification with plot attached
        ...
        print("Email notification not sent (disabled).")